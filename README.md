...
| `Wiki_Arch_GLM/` | 13 | 6,880 |
| `Wiki/` (новая, DDD) | 13 | 1,890 |
| `IPFRS_ARCHITECTURE.md` | 1 | 1,599 |
| `Wiki_GLM/` | 2 | 1,544 |
| `RoadMap/` | 7 | 1,536 |
| `README.md` (корень) | 1 | 466 |
| `CONTRIBUTORS.md` | 1 | 18 |
| **Итого (архитектура)** | **58** | **22,786** |

> **22,786 строк** документации архитектуры в **58 Markdown-файлах** (7 баз знаний + корневые доки).  
> **3 «живые» вики**: [`Wiki/`](Wiki/00-INDEX.md) (DDD, выверена по коду), [`Wiki_Antropic/`](Wiki_Antropic/INDEX.md) (доменные статьи), [`Wiki_Arch_GLM/`](Wiki_Arch_GLM/00-INDEX.md) (GLM-вариант, `06-LogicContext` углублён до 1356 строк).  
> Всего Markdown в репозитории (без `target/`, `Vendor/`): **132 файла, 57,164 строки** — остальное это доки исходников и служебное.  
> _Пересчитано 2026-06-19 — выверено по рабочему дереву._
