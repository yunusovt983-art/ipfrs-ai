...
14. **[[14-HLD]]** - Helicopter View / HLD (ASCII)
    - Проблема, границы системы, архитектура одним взглядом, 3 ключевых потока, 5 решений
    - ⏱️ 15 мин · ✅ Complete — **рекомендуется читать первым**

15. **[[15-HLD-Mermaid]]** - Helicopter View / HLD в Mermaid-диаграммах
    - 15 диаграмм: C4 контекст, CID-токен, карта BC, декораторы, ADD/GET/SEARCH/QUERY flows
    - Рендерятся нативно в Obsidian · ⏱️ 10 мин · ✅ Complete

### 🔎 Проверка реальности (модель vs код)

16. **[[12-RealityCheck]]** - Что реально работает, а что заглушка
    - Опровергнутые «security-баги» (JWT=HS256, backpressure корректен), реестр заглушек по контекстам, техдолг
    - Глубокое исследование 2026-06-19 (7 агентов, `file:line`) · ⏱️ 12 мин · ✅ Complete
...
- Статей: 15 (✅ все complete) + 4 meta-файла (README, INDEX, WIKI_SCHEMA, log)
- Строк: 8,200+
